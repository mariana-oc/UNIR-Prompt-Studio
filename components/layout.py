...
def render_hero() -> None:
    st.markdown(
        ...
        '<p>Generate production-ready AZUL and VERDE prompt variables directly from any UNIR course page.</p>'
        '</div>',
        unsafe_allow_html=True,
    )
...
def render_empty_state() -> None:
    st.markdown(
        ...
        'Paste a UNIR course URL, configure the visual parameters, and click '
        '<strong>Generate Variables</strong>.'
        '</div>',
        unsafe_allow_html=True,
    )
